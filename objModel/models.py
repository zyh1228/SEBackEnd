...
class ObjModel(models.Model):
    ...
    file_type = models.CharField(null=True, max_length=16, verbose_name='文件类型')
    model_file = models.FileField(null=True, upload_to=upload_obj_model_dir, default=path.join('default', 'default.obj'), verbose_name='模型文件')
